    ...
    public Commande upDateCommande(Commande cmd) {
        ...
        if(cmd ==null || cmd.getId() == null){
            ...
            ErrorCodes.COMM_INV);
                ...
                Commande commandeTrouver= commandeRepository.findById(cmd.getId()).get();
                commandeTrouver.setCreationDate(cmd.getCreationDate());
                commandeTrouver.setDateLivraison(cmd.getDateLivraison();
                commandeTrouver.setPrix(cmd.getPrix());
                commandeTrouver.setPrixUnitair(cmd.getCreationDate());
                commandeTrouver.setCreationDate(cmd.getCreationDate());
                commandeTrouver.setCreationDate(cmd.getCreationDate());
                commandeTrouver.setCreationDate(cmd.getCreationDate());
