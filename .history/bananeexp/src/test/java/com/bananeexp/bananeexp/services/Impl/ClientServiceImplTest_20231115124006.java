...
public class ClientServiceImplTest {
    ...
    public void testcreationSaveCommandeAvecSuc() {
        ...
        Commande comAtendu = new Commande(null,null,LocalDate.now().atStartOfDay(ZoneId.systemDefault()).toInstant(),dateLivraison, new BigDecimal(100), new BigDecimal(250), null);
